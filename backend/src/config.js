...
export const config = {
  ...
  // 合约地址
  kernelAddress: process.env.KERNEL_ADDRESS || '0x67d269191c92Caf3cD7723F116c85e6E9bf55933',
  entryPointAddress: process.env.ENTRY_POINT_ADDRESS || '0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512',

  // 代币地址 (用于gas补偿)
  tokenAddress: process.env.TOKEN_ADDRESS || '0xE6E340D132b5f46d1e472DebcD681B2aBc16e57E',
